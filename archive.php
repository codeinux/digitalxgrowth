    ...
    <div class="container">
      ...
      <?php if ( have_posts() ) : ?>
        <div class="section-headings" data-aos="fade-up">
          <?php
            the_archive_title( '<h1 class="heading text-50" data-aos="fade-up" data-aos-delay="50">', '</h1>' );
            the_archive_description( '<div class="taxonomy-description text text-18" data-aos="fade-up" data-aos-delay="100" style="margin-top: 15px;">', '</div>' );
          ?>
        </div>
        ...
        ?>
        <nav class="pagination" data-aos="fade-up" aria-label="<?php esc_attr_e( 'Archive pagination', 'digitalgrowth' ); ?>">
      ...
      <?php else : ?>
        <div class="section-headings" data-aos="fade-up">
          <h1 class="heading text-50" data-aos="fade-up" data-aos-delay="50">
            <?php esc_html_e( 'Nothing Found', 'digitalgrowth' ); ?>
          </h1>
          <p class="text text-18" style="padding:40px 0;">
            <?php esc_html_e( 'It seems we can&rsquo;t find any posts matching your request.', 'digitalgrowth' ); ?>
          </p>
        </div>
      <?php endif; ?>
