            ...
            <div class="row footer-custom-row">
              ...
              <div class="col-12 col-md-6">
                <div class="footer-widget footer-widget-brand" data-aos="fade-up" data-aos-anchor=".footer-top">
                  <a class="footer-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php bloginfo( 'name' ); ?> Logo">
                    <?php if ( has_custom_logo() ) :
                      the_custom_logo();
                    else : ?>
                      <img
                        src="<?php echo get_template_directory_uri(); ?>/assets/imgs/logo-white.png"
                  ...
                  <ul class="social-icons list-unstyled" data-aos="fade-up" data-aos-anchor=".footer-top">
                    ...
                    <li>
                      <a class="social-link text" href="<?php echo esc_url( $li ); ?>" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
                        <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.78357 2.16742C3.78326 2.84601 3.37157 3.45666 2.74262 3.71142C2.11367 3.96619 1.39306 3.81419 0.920587 3.32711C0.448112 2.84001 0.318129 2.11511 0.59192 1.49421C0.86572 0.873305 1.48862 0.480397 2.1669 0.500755C3.0678 0.527797 3.78398 1.26612 3.78357 2.16742ZM3.83357 5.06742H0.500237V15.5007H3.83357V5.06742ZM9.10025 5.06742H5.78357V15.5007H9.06692V10.0257C9.06692 6.97573 13.0419 6.6924 13.0419 10.0257V15.5007H16.3336V8.8924C16.3336 3.75075 10.4503 3.94242 9.06692 6.4674L9.10025 5.06742Z" fill="currentColor"/></svg>
              ...
              <div class="col-12 col-md-6">
                <div class="footer-widget footer-widget-menu" data-aos="fade-up" data-aos-anchor=".footer-top">
                  ...
                  <ul class="footer-menu list-unstyled">
                    <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="text text-16 link"><?php esc_html_e( 'Home', 'digitalgrowth' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/about/' ) ); ?>" class="text text-16 link" aria-label="About Us"><?php esc_html_e( 'About Us', 'digitalgrowth' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/services/' ) ); ?>" class="text text-16 link" aria-label="Services"><?php esc_html_e( 'Services', 'digitalgrowth' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/pricing/' ) ); ?>" class="text text-16 link" aria-label="Pricing Plans"><?php esc_html_e( 'Pricing Plans', 'digitalgrowth' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/blog/' ) ); ?>" class="text text-16 link" aria-label="Blogs"><?php esc_html_e( 'Blogs', 'digitalgrowth' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>" class="text text-16 link" aria-label="Contact Us"><?php esc_html_e( 'Contact Us', 'digitalgrowth' ); ?></a></li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col-12 col-md-6">
                <div class="footer-widget footer-widget-menu" data-aos="fade-up" data-aos-anchor=".footer-top">
                  ...
                  <ul class="footer-menu list-unstyled">
                    <li><a href="<?php echo esc_url( home_url( '/services/' ) ); ?>" class="text text-16 link"><?php esc_html_e( 'SEO Audit', 'digitalgrowth' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/services/' ) ); ?>" class="text text-16 link"><?php esc_html_e( 'Competitor Analysis', 'digitalgrowth' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/services/' ) ); ?>" class="text text-16 link"><?php esc_html_e( 'High-Authority Backlinks', 'digitalgrowth' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/services/' ) ); ?>" class="text text-16 link"><?php esc_html_e( 'Digital Marketing', 'digitalgrowth' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/services/' ) ); ?>" class="text text-16 link"><?php esc_html_e( 'Web Development', 'digitalgrowth' ); ?></a></li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col-12 col-md-6">
                <div class="footer-widget footer-widget-menu" data-aos="fade-up" data-aos-anchor=".footer-top">
                  ...
                  <ul class="footer-menu list-unstyled">
                    <li><a href="<?php echo esc_url( home_url( '/about/' ) ); ?>" class="text text-16 link"><?php esc_html_e( 'Working Process', 'digitalgrowth' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/privacy-policy/' ) ); ?>" class="text text-16 link"><?php esc_html_e( 'Privacy Policy', 'digitalgrowth' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/terms-conditions/' ) ); ?>" class="text text-16 link"><?php esc_html_e( 'Terms & Conditions', 'digitalgrowth' ); ?></a></li>
                    <li><a href="<?php echo esc_url( home_url( '/faq/' ) ); ?>" class="text text-16 link"><?php esc_html_e( 'FAQs', 'digitalgrowth' ); ?></a></li>
                  </ul>
                </div>
              </div>
          ...
          <div class="row footer-bottom-row">
            ...
            <div class="col-12 col-md-6 col-lg-6">
              <ul class="footer-menu footer-policies list-unstyled">
                <li><a href="<?php echo esc_url( home_url( '/privacy-policy/' ) ); ?>" class="text text-16 link"><?php esc_html_e( 'Privacy Policy', 'digitalgrowth' ); ?></a></li>
                <li><a href="<?php echo esc_url( home_url( '/faq/' ) ); ?>" class="text text-16 link"><?php esc_html_e( 'FAQs', 'digitalgrowth' ); ?></a></li>
                <li><a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>" class="text text-16 link"><?php esc_html_e( 'Contact', 'digitalgrowth' ); ?></a></li>
              </ul>
            </div>
          </div>
        </div>
